...
st.text('While working for long hours or even short durations on your laptops/computers/phones, the webcam on your device can be used to take in your facial input in real-time. We dynamically curate and play songs to help users focus taking into account what seems to be working and what does not; thus creating the perfect environment for your needs. More specifically, it assists people with attention deficit disorders -ADD, ADHD- to focus and concentrate on important tasks consistently when it may seem tough to do so. 
