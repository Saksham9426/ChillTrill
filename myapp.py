...
st.title('ChillTrill')
st.caption('An advanced webapp that utilizes deep learning and AI-ML technology to detect micro-changes in your facial expressions, allowing it to assess if the currently played music is inducing a calming effect for you. It can detect different emotions for example happy, sad, angry, calm, neutral; based on which, it dynamically consistently changes the music selection according to the data it collects of songs which seem to calm your and help you focus on your tasks.')
st.markdown('While working for long hours or even short durations on your laptops/computers/phones, the webcam on your device can be used to take in your facial input in real-time. We dynamically curate and play songs to help users focus taking into account what seems to be working and what does not; thus creating the perfect environment for your needs. More specifically, it assists people with attention deficit disorders -ADD, ADHD- to focus and concentrate on important tasks consistently when it may seem tough to do so. 
Your privacy is of the utmost importance, therefore none of the video inputs taken in real-time are stored or sent anywhere, it is only used to determine your current sentiment analysis to better curate music playlists automatically for our users and help them focus and aid in productivity with scientifically researched and tested data.')
st.markdown('')
